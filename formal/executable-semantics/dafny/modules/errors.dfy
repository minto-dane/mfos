...
module Errors {
  ...
  | MFOS_ERR_INVALID_AUDIT_RECORD
  | MFOS_ERR_AUDIT_CHAIN_INVALID
  | MFOS_ERR_REDACTION_POLICY_FAILED
  | MFOS_ERR_AUDIT_RECORD_DUPLICATE
  | MFOS_ERR_AUDIT_SEQUENCE_INVALID
  | MFOS_ERR_POLICY_LINT_FAILED
  ...
  function ErrorRank(error: ErrorCode): nat {
    ...
    case MFOS_ERR_INVALID_AUDIT_RECORD => 12
    case MFOS_ERR_AUDIT_CHAIN_INVALID => 13
    case MFOS_ERR_REDACTION_POLICY_FAILED => 14
    case MFOS_ERR_AUDIT_RECORD_DUPLICATE => 15
    case MFOS_ERR_AUDIT_SEQUENCE_INVALID => 16
    case MFOS_ERR_POLICY_LINT_FAILED => 17
  }
