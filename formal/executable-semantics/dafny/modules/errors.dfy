...
module Errors {
  ...
  | MFOS_ERR_INVALID_DATASET_NAME
  | MFOS_ERR_INVALID_PARAMETER
  | MFOS_ERR_IMMUTABLE
  | MFOS_ERR_RETENTION_DENIED
  | MFOS_ERR_RETENTION_ACTIVE
  | MFOS_ERR_INTERNAL_CORRUPTION
  | MFOS_ERR_ENCRYPTION_POLICY_UNAVAILABLE
  ...
  | INVALID_DSN
  | RETENTION_ACTIVE
  | IMMUTABLE_SYSTEM_DATASET
  | INTERNAL_CORRUPTION
  | POSIX_FILE_MODEL_REJECTED
  ...
  function ErrorRank(error: ErrorCode): nat {
    ...
    case MFOS_ERR_INVALID_DSN => 12
    case MFOS_ERR_INVALID_DATASET_NAME => 13
    case MFOS_ERR_INVALID_PARAMETER => 14
    case MFOS_ERR_IMMUTABLE => 15
    case MFOS_ERR_RETENTION_DENIED => 16
    case MFOS_ERR_RETENTION_ACTIVE => 17
    case MFOS_ERR_INTERNAL_CORRUPTION => 18
    case MFOS_ERR_ENCRYPTION_POLICY_UNAVAILABLE => 19
    case MFOS_ERR_INVALID_AUDIT_RECORD => 20
    case MFOS_ERR_AUDIT_CHAIN_INVALID => 21
    case MFOS_ERR_REDACTION_POLICY_FAILED => 22
    case MFOS_ERR_AUDIT_RECORD_DUPLICATE => 23
    case MFOS_ERR_AUDIT_SEQUENCE_INVALID => 24
    case MFOS_ERR_POLICY_LINT_FAILED => 25
  }
