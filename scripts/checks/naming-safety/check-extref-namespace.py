...
from lib.mfos_lint import Finding, ROOT, emit, load_yaml, mode_arg, source_ids, text_files
            ...
            def walk(value: object, owner: str = "") -> None:
                if isinstance(value, dict):
                    ...
                    if isinstance(sid, str):
                        ...
                        elif sid not in known and sid.startswith("EXTREF-") and "sources" not in path.parts:
