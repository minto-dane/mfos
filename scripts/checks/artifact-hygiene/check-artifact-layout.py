...
CANONICAL_ROOT_FILES_ALLOWED = {
    ...
    Path("scripts"): {
        ...
        "check-phase1-4-1-job-dd-coverage.py",
        "check-phase1-4-2-spool-coverage.py",
...
ROOT_CHECK_WRAPPERS = {
    ...
    "check-phase1-4-1-job-dd-coverage.py": "phases/phase-1/check-phase1-4-1-job-dd-coverage.py",
    "check-phase1-4-2-spool-coverage.py": "phases/phase-1/check-phase1-4-2-spool-coverage.py",
