...
from lib.mfos_lint import EVIDENCE, REQUIREMENTS, ROOT, SOURCE_INDEX, SPECS_DIR, TESTS, load_yaml, parse_front_matter
...
def main() -> int:
    ...
    envelope = {
        ...
        "generated_by": "scripts/generators/generate-traceability.py",
