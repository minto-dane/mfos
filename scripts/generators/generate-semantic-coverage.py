...
TEST_COVERAGE: dict[str, dict[str, Any]] = {
    ...
    "NEG-MFOS-DATASET-MALFORMED-DSN-0902": entry("C2_PARTIAL_SEMANTIC", [semantic("dataset_catalog", "SymbolicDsnValid", "predicate", "C2_PARTIAL_SEMANTIC", "Malformed DSN rejection and MFOS_ERR_INVALID_DATASET_NAME are not modeled in Dafny.")], "Downgraded because no matching invalid-DSN error property exists."),
...
def build_artifacts() -> dict[str, Any]:
    ...
    summary = {
        ...
        "dafny_verification_result": "49 verified, 0 errors",
