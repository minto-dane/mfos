...
| Language and formal assurance planning | EXTREF-RUST-UNSAFE-REFERENCE-0001, EXTREF-RUST-NO-STD-REFERENCE-0001, EXTREF-RUST-CF-PROTECTION-0001, EXTREF-CLANG-CFI-0001, EXTREF-CLANG-KCFI-0001, EXTREF-GCC-CF-PROTECTION-0001, X64-LINUX-CET-001, EXTREF-INTEL-CET-0001, EXTREF-KANI-RUST-VERIFIER-0001, EXTREF-VERUS-RUST-VERIFICATION-0001, EXTREF-AWS-AUTOMATED-REASONING-0001, EXTREF-GITHUB-CODEQL-0001, EXTREF-NIST-SECURE-SYSTEMS-ENGINEERING-0001, EXTREF-NIST-SSDF-0001 | MFOS-REQ-LANG-*, MFOS-REQ-FORMAL-* | `39-language-and-verification-policy.md`, `40-automated-reasoning-program.md` | proof claim without artifact, unsafe boundary without contract, no_std runtime contract missing, CFI/CET overclaim, CodeQL overclaim, model omitted from registry | EV-MFOS-LANG-*, EV-MFOS-FORMAL-* | Planned proof registry only; no proof claim. Rust/Clang/GCC target support and toolchain pins pending. |
