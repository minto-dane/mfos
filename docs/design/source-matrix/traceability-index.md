...
| formal assurance and proof boundaries | SEL4-001, NIST-160-001, FBVBS-001, EXTREF-DAFNY-REFERENCE-0001 | MFOS-REQ-QUAL-*, MFOS-REQ-SI-*, MFOS-REQ-PXM-*, MFOS-REQ-GRD-*, MFOS-REQ-DAFNY-* | `04-threat-model.md`, `03-system-integrity.md`, `16-pxm.md`, `17-guard.md`, `22-production-readiness.md`, `43-dafny-executable-semantics-policy.md` | proof assumes unlisted hardware behavior, formal model omits unauthorized success, liveness without audit, invalid transition missing, Dafny loader-only scope bypass | EVID-FORMAL-SI-*, EVID-FORMAL-PXM-*, EVID-FORMAL-GRD-*, EVID-ARCH-REVIEW-* | B core state machines; E core plus security; HA core plus security plus Guard | Formal language selection and first model list pending. |
...
## Phase 0.10 PXM/MFVM Routing Addendum

| Trace area | Source Matrix IDs | Requirement namespaces | Split specs | Minimum negative-test routing | Evidence routing | Phase gate |
| --- | --- | --- | --- | --- | --- | --- |
| MFVM and hypervisor-class virtualization planning | EXTREF-MICROSOFT-HYPERV-TLFS-0001, EXTREF-MICROSOFT-HYPERV-OVERVIEW-0001, EXTREF-LINUX-KVM-API-0001, EXTREF-LINUX-KVM-VFIO-0001, EXTREF-LINUX-KVM-CAPABILITIES-0001, X64-INTEL-001, X64-AMD-001 | MFOS-REQ-MFVM-*, MFOS-REQ-VIRT-*, MFOS-REQ-PXM-* | `36-hypervisor-class-virtualization.md`, `42-mfvm.md`, `16-pxm.md` | MFVM bypasses PXM, MFVM owns VMX/SVM roots, external API compatibility claim, unchecked capability request | EV-MFOS-MFVM-*, EV-MFOS-VIRT-*, EV-MFOS-PXM-* | Future phase; no Phase 1 semantic evaluator. |
| Confidential VM planning | EXTREF-INTEL-TDX-OVERVIEW-0001, EXTREF-INTEL-TDX-ATTESTATION-0001, EXTREF-AMD-SEV-OVERVIEW-0001, EXTREF-AMD-SEV-SNP-0001, EXTREF-AMD-SEV-TIO-0001, TCG-001 | MFOS-REQ-CVM-* | `37-confidential-vm.md`, `42-mfvm.md` | secret release without attestation, launch without measurement, private/shared transition ambiguity | EV-MFOS-CVM-* | Future phase; no secret-release implementation. |
| Language and formal assurance planning | EXTREF-RUST-UNSAFE-REFERENCE-0001, EXTREF-RUST-NO-STD-REFERENCE-0001, EXTREF-RUST-CF-PROTECTION-0001, EXTREF-CLANG-CFI-0001, EXTREF-CLANG-KCFI-0001, EXTREF-GCC-CF-PROTECTION-0001, X64-LINUX-CET-001, EXTREF-INTEL-CET-0001, EXTREF-KANI-RUST-VERIFIER-0001, EXTREF-VERUS-RUST-VERIFICATION-0001, EXTREF-DAFNY-REFERENCE-0001, EXTREF-AWS-AUTOMATED-REASONING-0001, EXTREF-GITHUB-CODEQL-0001, EXTREF-NIST-SECURE-SYSTEMS-ENGINEERING-0001, EXTREF-NIST-SSDF-0001 | MFOS-REQ-LANG-*, MFOS-REQ-FORMAL-*, MFOS-REQ-DAFNY-* | `39-language-and-verification-policy.md`, `40-automated-reasoning-program.md`, `43-dafny-executable-semantics-policy.md` | proof claim without artifact, unsafe boundary without contract, no_std runtime contract missing, CFI/CET overclaim, CodeQL overclaim, model omitted from registry, Dafny-generated code treated as production | EV-MFOS-LANG-*, EV-MFOS-FORMAL-* | Planned proof registry only; no proof claim. Rust/Clang/GCC/Dafny target support and toolchain pins pending. |
| Datacenter and secure operations planning | NIST-160-001, NIST-218-001, SLSA-001, TCG-001, EXTREF-MICROSOFT-HYPERV-OVERVIEW-0001 | MFOS-REQ-CLUSTER-*, MFOS-REQ-OPS-*, MFOS-REQ-PERF-* | `38-datacenter-cluster-operations.md`, `41-performance-and-secure-operations.md` | placement treated as enforcement, policy distribution without audit, break-glass without expiry, missing SLSA provenance, performance claim without benchmark evidence | EV-MFOS-CLUSTER-*, EV-MFOS-OPS-*, EV-MFOS-PERF-* | Future phase; no cluster scheduler. SLSA target level and provenance verification policy pending. |
