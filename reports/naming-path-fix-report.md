...
- `reports/mfos-owned-name-audit.yml`
- `reports/repo-audit.md`
- `reports/repo-audit.yml`
...
```sh
rg -n "implementation/interfaces/(tso-like|ispf-like|zosmf-like-api)|implementation/services/(tsoed|ispfd)" . -S -g '!reports/naming-path-fix-report.md'
rg -n "\b(tso-like|ispf-like|zosmf-like-api|tsoed|ispfd)\b" implementation reports scripts/bootstrap-tree.sh -S -g '!reports/naming-path-fix-report.md'
