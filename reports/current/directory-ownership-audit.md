...
| --- | --- | --- | --- | --- | --- |
| `implementation/services/` | `services/` | `implementation/services/` after future gate | `services/` metadata-only bridge | High | Block ready service tasks and keep top-level bridge metadata-only. |
| `implementation/nucleus/` | `nucleus/` | `implementation/nucleus/` after future gate | top-level metadata-only bridge | Medium | Keep metadata and forbid implementation code. |
| `implementation/pxm/` | `pxm/` | `implementation/pxm/` after future gate | top-level metadata-only bridge | Medium | Keep metadata and forbid implementation code. |
| `implementation/guard/` | `guard/` | `implementation/guard/` after future gate | top-level metadata-only bridge | Medium | Keep metadata and forbid implementation code. |
